        ...
        <div class="flex flex-col gap-6 md:flex-row md:flex-wrap md:justify-between md:gap-4 lg:flex-nowrap">
          <div class="max-w-xs">
            ...
            <div class="mt-6 flex items-center gap-4 md:gap-2 md:mt-10 md:gap-7">
              <button
                role="group"
                class="cursor-pointer flex shrink-0 gap-2 items-center justify-center w-fit rounded-full focus-visble:ring focus-visble:ring-gray-800 focus-visble:ring-opacity-10 ring-gray-800 focus:outline-none transition-all duration-300 select-none disabled:opacity-80 text-gray-50 dark:text-gray-900 bg-gray-900 dark:bg-gray-50 hover:bg-gray-800 dark:hover:bg-gray-100 p-3  gap-4 text-black "
                type="button"
              >
                <svg
                  stroke="currentColor"
          ...
          <div class="space-y-4 md:space-y-6  ">
            <h4 class="text-sm font-semibold md:text-lg text-black">DOWNLOAD THE APP</h4>
            <button
